...
$(()=>{
    $('button#startgame').on('click',()=>{
        ...
        var time=300000
        $('.bm1').css({'background-image':'url(./jpg/number'+parseInt((time/1000)/600)+'.png)'})
        $('.bm2').css({'background-image':'url(./jpg/number'+parseInt((time/1000)/60)+'.png)'})
        $('.bm3').css({'background-image':'url(./jpg/number'+parseInt(((time/1000)%60)/10)+'.png)'})
        $('.bm4').css({'background-image':'url(./jpg/number'+((time/1000))%10+'.png)'})
